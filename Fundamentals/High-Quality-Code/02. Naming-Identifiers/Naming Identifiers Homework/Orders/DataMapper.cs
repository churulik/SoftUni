...
namespace Orders
{
    public class DataMapper
    {
        ...
        {
            var categoriesInput = ReadFileLines(this.categoriesFileName, true);
        ...
        {
            var productsInput = ReadFileLines(this.productsFileName, true);
        ...
        {
            var ordersInput = ReadFileLines(this.ordersFileName, true);
            return ordersInput
                .Select(p => p.Split(','))
                .Select(p => new Order
                {
