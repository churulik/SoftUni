...
var TodoList = (function () {
    ...
    function addButton(buttonId, onclickFunction, buttonText, containerId) {
    ...
    var Container = (function () {
        ...
        Container.prototype.addToDom = function () {
            ...
            getElementById('wrapper').appendChild(container);
            ...
            addButton('add-section-button-' + nameForId, 'addSection(this.id)', 'New section', sectionContainerId);
    ...
    var Section = (function () {
        function Section(title, sectionContainerId) {
        ...
        Section.prototype.addToDom = function () {
            ...
            var sectionContainer = getElementById(this.sectionContaineId);
            ...
            addButton('add-item-button-' + sectionForId, 'addItem(this.id)', '+', itemContainerId);
        };
...
function addSection(buttonId) {
    var inputId = buttonId.replace('button', 'input');
    var sectionContainerId = buttonId.replace('add-section-button', 'section-container');
    var sectionTitle = getElementById(inputId).value;
    var section = new TodoList.Section(sectionTitle, sectionContainerId);
    section.addToDom();
}
